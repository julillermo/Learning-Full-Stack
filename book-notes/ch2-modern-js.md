...
- ES.Next modules:
  - `named` and `default` exports. The book suggests `named` exports as the better practice
...
- Concept of **"Asynchronous Scripts"**
  ...
  - The previous preferred way of handling this was to use **"Promises"**
  ...
  - Moden JS prefers using `async/await`
...
- Since the runtime is in bun instead of node.js:
